...
public class MySQL_CON_Spieler {
	...
	public static void connect(){
		if(!isConnected()){
			try {
				...
				System.out.println("[MySQL-Spieler] Die Verbindung wurde aufgebaut");
	...
	public static void disconnect(){
		if(isConnected()){
			try {
				con.close();
				System.out.println("[MySQL-Spieler] Die Verbindung wurde getrennt");
			} catch (SQLException e) {
				e.printStackTrace();
			}
		}
